...
import com.johnsonnyamweya.bazar.Model.Cart;
import com.johnsonnyamweya.bazar.Prevalent.Prevalent;
import com.johnsonnyamweya.bazar.R;
import com.johnsonnyamweya.bazar.ViewHolder.CartViewHolder;
...
public class CartActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = (RecyclerView) findViewById(R.id.cart_list_rv);
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Cart, CartViewHolder> adapter =
            ...
            protected void onBindViewHolder(@NonNull CartViewHolder holder, int position, @NonNull Cart model) {
                ...
                holder.txtProductPrice.setText("Price = KShs" + model.getPrice().toString());
                holder.txtProductName.setText(model.getpName().toString());
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    if (shippingState.equals("shipped")){
                        ...
                        Toast.makeText(CartActivity.this,
                                "You can purchase more products once you receive your first final order", Toast.LENGTH_SHORT).show();
